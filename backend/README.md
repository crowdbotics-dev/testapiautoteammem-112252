...
## Project Structure
    ...
    ├── testapiautoteammem_112252  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112252`
...
2. Clone this repo and `cd testapiautoteammem_112252`
